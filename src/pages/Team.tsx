  ...
  const teamMembers = [
    {
      ...
      bio: [
        ...
        "Back in April 2022, RJ was introduced to AI through a company called Catapult AI. The concept was promising—use AI to build world-class KPIs based on SIC and NAICS codes—but the tech wasn't ready. What it did spark was something far more valuable: RJ's curiosity. It planted the seed that AI could be more than hype—it could be a force multiplier for businesses if applied with purpose.",
