  ...
  const teamMembers = [
    {
      ...
      bio: [
        ...
        <>Back in April 2022, RJ was introduced to AI through a company called <a href="https://www.catipult.ai" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">Catapult AI</a>. The concept was promising: use AI to build world-class KPIs based on SIC and NAICS codes. But the tech wasn't ready. What it did spark was something far more valuable: RJ's curiosity. It planted the seed that AI could be more than hype and could be a force multiplier for businesses if applied with purpose.</>,
        ...
        "He leads with a strategy-before-tools mindset. He reads academic and government papers on ethics, security, and IP. And he believes AI isn't here to replace leadership but to amplify it.",
